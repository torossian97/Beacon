 ...
 * {@link barChart.OnFragmentInteractionListener} interface
...
public class barChart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chart = (ColumnChartView) rootView.findViewById(R.id.chart2);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.bar_chart, menu);
    }
    ...
    /**
     * To animate values you have to change targets values and then call {@link barChart#startDataAnimation()}
